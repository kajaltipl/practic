...
<body>
	...
	<br/><br/>
     ...
     <form method="post" name="form1" action="" enctype="multipart/form-data">      
       ...
       <?php $strSQL =  ;
       echo $strSQL;?>
        <td><input type="text" name="pro_cat_id" value="<?php echo $pro_cat_id;?>"></td>
	...
	<?php
      ...
      if(isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO product (p_name,p_desc,p_img,p_status,pro_cat_id) VALUES ('$p_name', '$p_desc', '$p_img', '$p_status','$pro_cat_id')";
        //img update  
        //  print_r($sql);
